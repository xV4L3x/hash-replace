...
NSString *owoify (NSString *text) {
    ...
    NSString *finalOutput = [output stringByReplacingOccurrencesOfString:@" " withString:@""];

    return [@" " stringByAppendingString:finalOutput];
}
...
-(id)initWithFrame:(CGRect)arg1 {
    ...
    self.slcOwOItem = [[UIMenuItem alloc] initWithTitle:@"Sha1" action:@selector(slcOwO:)];
